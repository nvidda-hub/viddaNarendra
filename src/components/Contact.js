...
function Contact() {
  ...
  return <div id="contact" className='bg-white flex snap-start'>
      ...
      <div className='flex-1 flex flex-col items-center justify-center' onSubmit={handleSubmit}>
        ...
        <span className='w-2/5 h-0.5 bg-black'></span>
        <form className='w-[70%] h-[70%] flex flex-col items-center justify-around'>
          <input type="text" placeholder="Email" className='w-[300px] h-[30px] text-[14px] border-2 border-slate-300 border-solid rounded-sm'/>
          <textarea placeholder='Message' className='w-[300px] h-[200px] text-[14px] border-2 border-slate-300 border-solid rounded-sm'></textarea>
